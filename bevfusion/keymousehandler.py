...
class KeyMouseHandler():
    ...
    def __init__(self, in_img_size=(320, 240), out_img_size=(320, 240)):
        ...
        self.key_list = [
            {'key': 'o', 'fn': 'fn_select_in_points', 'state': 1, 'color': [0, 0, 255], 'trans': 1, 'nr_points': 4,
             'info': 'select with mouse 4 input points, adjust with wasd'},
            {'key': 'p', 'fn': 'fn_select_out_points', 'state': 2, 'color': [255, 0, 0], 'trans': 2, 'nr_points': 4,
             'info': 'select with mouse 4 output points, ajust with wasd'},
            {'key': 't', 'fn': 'fn_transform', 'state': 3, 'info': 'transform'},
            {'key': 'e', 'fn': 'fn_edit_np', 'state': 4, 'color': [255, 0, 255], 'nr_points': 1,
             'info': 'edit the nearest point'},
        ]
